...
internal class LongReport(List<SymbolWithAggregatedScore> symbolsWithScores) : IDocument
{
        ...
        foreach (var symbol in SymbolsWithScores)
        {
            container.Page(page =>
            {
                ...
                page.Content().Column(column =>
                {
                    ...
                    column.Item()
                        .PaddingTop(10)
                        .Text(symbol.Symbol.Overview.InvestorRelationsWebsite)
                        .FontSize(10);
                    ...
                    column.Item()
                        .PaddingTop(10)
                        .Text("Yearly dividend: " + symbol.Symbol.Overview.DividendPerShareYearly + " " + symbol.Symbol.Overview.Currency)
                        .FontSize(10);

                    column.Item()
                    .PaddingTop(10)
                    .Image(SaveLocationsConfiguration.GetGrowthAnalysisSaveFileLocation(symbol.Symbol, symbol.Symbol.GVA_2Years));

                    column.Item()
                    .PaddingTop(10)
                    .Image(SaveLocationsConfiguration.GetMaxLossAnalysisSaveFileLocation(symbol.Symbol, symbol.Symbol.GVA_2Years));
                });
            });
        }
    }
